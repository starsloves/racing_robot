...
def load_direct_inertial_test_params(debug_log_path_value: str = '') -> dict:
    ...
    params.update({
        ...
        'field_track_config': '',
        'detour_obstacle_detect_distance': 0.55,
        'detour_obstacle_clear_distance': 0.65,
        'avoid_watch_distance_m': 0.55,
        'avoid_commit_distance_m': 0.40,
        'avoid_triangle_trigger_m': 0.50,
        'avoid_triangle_bias_deg': 30.0,
        'avoid_triangle_leg_m': 0.80,
        'avoid_bias_yaw_deg': 30.0,
        'avoid_bias_yaw_max_deg': 30.0,
